...
In Mr. Trash Wheel dataset, there are '`r nrow(mr_trash)`' observations.


In precipitation(2017-2018) dataset,  there are `r nrow(pct_17_18)` observations, with 3 variables, indicating
the total precipitation data for 19 months in 2017 and 2018. 
The total precipitation in 2017 and 2018 are `r sum(pull(filter(pct_17_18,year == 2017),total))` 
and `r sum(pull(filter(pct_17_18,year == 2018),total))` respectively. Besides, the average precipitation in 2017 and 2018 are 
`r round(mean(pull(filter(pct_17_18,year == 2017),total)), digits=2) ` 
and `r round(mean(pull(filter(pct_17_18,year == 2018),total)), digits=2)` respectively.
